...
public class cardsControllerHard implements Initializable {
    ...
    GameHardMode GameHardMode = new GameHardMode();

    @FXML
    private Button button0, button1, button2, button3, button4, button5, button6, button7, button8, button9, button10, button11, button12, button13, button14, button15, button16, button17, button18, backButton,
    ...
    Timeline hideReveal = new Timeline(new KeyFrame(Duration.seconds(3), e -> hideAll()));
    ...
    void buttonClicked(ActionEvent event) throws IOException {
        ...
        if(!firstButtonClicked){
            ...
            Color color = GameHardMode.getOptionAtIndex(firstButtonIndex);
        ...
        Color color = GameHardMode.getOptionAtIndex(secondButtonIndex);
        BackgroundFill backgroundFill = new BackgroundFill(color, CornerRadii.EMPTY, Insets.EMPTY);
        Background background = new Background(backgroundFill);
        ...
        if(GameHardMode.checkTwoPositions(firstButtonIndex,secondButtonIndex)){
            score += 50;
            match = true;
            matchedButtons += 2;
    ...
    private void saveScores() {
        try {
            FileWriter fileWriter = new FileWriter("C:\\Users\\Monica Villanueva\\IntelliJ Projects\\findMyPairFinal\\src\\main\\java\\scoresTextFiles\\hardScores.txt", true);
    ...
    private void showButtons(){
        for (int i = 0; i < 24; i++) {
            Color color = GameHardMode.getOptionAtIndex(i);
            BackgroundFill backgroundFill = new BackgroundFill(color, CornerRadii.EMPTY, Insets.EMPTY);
            Background background = new Background(backgroundFill);
